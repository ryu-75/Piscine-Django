...
class Articles(models.Model):
    ...
    def remove_article(self, user: AbstractBaseUser | AnonymousUser, article_id: str) -> bool:
        """
...
class UserFavoriteArticle(models.Model):
    ...
    def add_to_favorite_article(self, user: AbstractBaseUser | AnonymousUser, article_id: str) -> bool:
        """
    ...
    def remove_from_favorite(self, user: AbstractBaseUser | AnonymousUser, article_id: str) -> bool:
        """
