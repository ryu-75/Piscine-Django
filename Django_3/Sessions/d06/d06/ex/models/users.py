...
class CustomUserManager(BaseUserManager):
    def attr_permission(self, user: AbstractBaseUser):
        try:
            users = get_object_or_404(Users, pk=user.id)
    ...
    for authentication.
    """
    def create_user(self, username: str, password=None) -> AbstractBaseUser:
        """
